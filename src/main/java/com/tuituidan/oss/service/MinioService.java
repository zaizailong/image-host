...
public class MinioService {
    ...
    public String presignUrl(String bucket, String fileName) {
        String url = null;
        try {
    ...
    public List<String> listObject(String bucket, String prefix) {
        ...
        for (Result<Item> chunk : chunks) {
            objectUrls.add(chunk.get().objectName());
        }
        return objectUrls;
    }

    @SneakyThrows
    public void composeObject(String objectName, List<ComposeSource> sourceList){
